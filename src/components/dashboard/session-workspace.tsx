...
export function SessionWorkspace({
  ...
  return (
    <section className="min-h-0 min-w-0 bg-white dark:bg-slate-950">
      <div className="flex h-full min-h-0 flex-col overflow-hidden">
        ...
        <div className={`grid min-h-0 flex-1 grid-cols-1 gap-0 overflow-hidden ${eventsOpen ? 'xl:grid-cols-[minmax(0,1fr)_300px]' : ''}`}>
          ...
          {/* Collapsible events panel. When closed, the entire column disappears so
              ...
              messages column. */}
          {eventsOpen && (
            <div className="relative min-h-0 overflow-y-auto border-t border-slate-200 bg-slate-50 dark:border-slate-800 dark:bg-slate-900/70 xl:border-l xl:border-t-0">
              <button
